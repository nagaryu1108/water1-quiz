...
/* Evidence-count scheduler v11. Counts are publicly confirmed LOWER BOUNDS, not a claimed full census. */
var PROFILES=[
...
window.WATER1_FREQUENCY_SCHEDULER={enabled:true,version:'v11-count-evidence-h21-correction',method:'subject-balanced coverage -> confirmed lower-bound frequency; review -> frequency x personal weakness',profiles:PROFILES.map(function(p){return {theme:p.name,confirmedYearsMin:p.yearsMin,confirmedQuestionsMin:p.questionsMin,weight:p.weight};}),provisional:true,note:'H21 hazardous mapping corrected from public PDF: Q4 arsenic, Q5 selenium, Q6-Q7 cyanide. Counts remain lower bounds until the 2006-2025 matrix is complete.'};
}
