...
const index=fs.readFileSync(path.join(root,'index.html'),'utf8'),enrich=fs.readFileSync(path.join(root,'qbank_enrichment_v7.js'),'utf8');
...
console.log('DUPLICATE_ENRICH_UI',/function enrich\(x\)/.test(index)&&/function showExtras\(x\)/.test(enrich));
