(function(){
  ...
  if(document.readyState==='loading'){
    ...
    document.write('<script src="./qbank_exam_difficulty_stage3_v49.js?v=145"><\/script>');
    document.write('<script src="./qbank_exam_difficulty_stage3_fix_v49.js?v=1451"><\/script>');
    document.write('<script src="./qbank_exam_difficulty_stage4_v50.js?v=146"><\/script>');
    document.write('<script src="./qbank_exam_difficulty_stage5_v51.js?v=147"><\/script>');
    document.write('<script src="./qbank_learning_visuals_v52.js?v=149"><\/script>');
    document.write('<script src="./visual_aid_audit_v53.js?v=150"><\/script>');
    ...
    document.write('<script src="./qbank_chem_typography_v59.js?v=157"><\/script>');
    document.write('<script src="./qbank_choice_independence_v60.js?v=158"><\/script>');
    document.write('<script src="./ui_polish_v46.js?v=158"><\/script>');
